  ...
  return <div className="contact-page">
    ...
    <main><section className="contact-hero section-pad">
      <div className="contact-hero-copy">
        ...
        <h1>Let&apos;s make your data <em>do more.</em></h1><p>Tell us what is slowing your team down. We&apos;ll help you find the cleanest way forward, from a focused data workflow to a fully managed AI operation.</p><div className="contact-proof"><span><Check size={15} /> 20+ years of experience</span><span><Check size={15} /> ISO-certified operations</span><span><Check size={15} /> Human + AI delivery</span></div></div><div className="contact-hero-art"><div className="contact-art-grid" /><div className="contact-signal signal-one" /><div className="contact-signal signal-two" /><div className="contact-art-card"><span className="mono-label">INQUIRY / 001</span><strong>From first<br />conversation<br /><em>to useful data.</em></strong><ArrowUpRight size={21} /></div><div className="contact-art-orbit" /></div></section>
