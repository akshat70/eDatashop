...
const posts = [
  { category: "Data operations", title: "Achieving High Accuracy at Low Costs: The Power of Data Entry Outsourcing", excerpt: "How specialist delivery combines cost-effectiveness with quality outcomes for data-driven teams.", date: "August 21, 2025", image: blog1, href: "/blogs/accuracy-outsourcing" },
  { category: "Security", title: "Ensuring Data Security in Data Entry Outsourcing: Best Practices and Precautions", excerpt: "A practical guide to protecting confidentiality, integrity, and availability when work moves beyond your walls.", date: "August 21, 2025", image: blog2, href: "/blogs/security-outsourcing" },
  { category: "Quality", title: "Enhancing Data Accuracy: Single Entry vs. Double Entry Methods", excerpt: "Understand the difference between single and double entry workflows and when each makes sense.", date: "August 21, 2025", image: blog3, href: "/blogs/single-double-entry" },
  { category: "Security", title: "Safeguarding Your Data: Best Practices for Secure Transmission in Data Entry Outsourcing", excerpt: "Essential precautions for moving financial, medical, and proprietary information safely.", date: "August 21, 2025", image: blog4, href: "/blogs/secure-transmission" },
  { category: "Data operations", title: "Mastering Handwritten Data Entry: Best Practices for Accuracy and Efficiency", excerpt: "Strategies for converting historical records, forms, and handwritten documents into dependable digital data.", date: "August 21, 2025", image: blog5, href: "/blogs/handwritten-data" },
  { category: "Workflow", title: "Streamlining Operations: A Comprehensive Guide to Outsourcing Forms Processing", excerpt: "The workflow, controls, and delivery practices behind efficient forms processing at scale.", date: "August 21, 2025", image: blog6, href: "/blogs/forms-processing" },
  { category: "Quality", title: "Outsourcing Form Data Entry: Strategies for Cost Control and Quality Assurance", excerpt: "How to manage cost factors without compromising the accuracy and consistency of form data.", date: "August 21, 2025", image: blog7, href: "/blogs/form-data-entry" },
  { category: "Strategy", title: "To Outsource Data Entry or Not: Making the Right Choice for Your Business", excerpt: "A balanced framework for deciding when external expertise can improve efficiency and business focus.", date: "August 21, 2025", image: blog8, href: "/blogs/outsource-decision" },
  { category: "People", title: "Ethical Outsourcing: Ensuring Fair Labor Practices in Data Entry Services", excerpt: "Why responsible delivery starts with fair, humane working conditions for the people behind the data.", date: "August 21, 2025", image: blog9, href: "/blogs/ethical-outsourcing" },
  { category: "India", title: "Empowering Communities Through Data Entry Services in India", excerpt: "The role of India’s data services sector in creating opportunity while delivering reliable business support.", date: "August 21, 2025", image: blog10, href: "/blogs/india-data-entry" },
  { category: "OCR & digitisation", title: "Clean Images: Precision OCR for Data Conversion", excerpt: "How scan quality influences OCR accuracy, accessibility, and the quality of the final digital record.", date: "October 13, 2025", image: blog11, href: "/blogs/clean-images-ocr" },
];
