...
const services = [
  ["01", FileCog, "Document AI & intelligent document processing", "Turn complex business documents into structured, searchable, actionable information.", ["Classification & extraction", "Invoice and form processing", "Human-in-the-loop validation"]],
  ["02", FileArchive, "Enterprise document digitization & OCR", "Move critical paper and image-based archives into clean, searchable digital systems.", ["High-volume scanning", "OCR & handwriting recognition", "Secure archive preparation"]],
  ["03", Boxes, "Data conversion & content transformation", "Transform content between formats, systems, and channels without losing the details that make it useful.", ["PDF, XML & database conversion", "Content restructuring", "Digital publishing workflows"]],
  ["04", Search, "Metadata enrichment & data cleansing", "Make enterprise information easier to find, trust, and reuse with consistent enrichment and QA.", ["Metadata modeling", "Deduplication & normalization", "Taxonomy alignment"]],
  ["05", GitBranch, "Data engineering & ETL", "Build dependable pipelines that move, transform, and prepare data for the teams and systems that need it.", ["Pipeline design", "Data integration", "Quality monitoring"]],
  ["06", Database, "Data migration & warehousing", "Migrate legacy information into modern warehouses and operating environments with less risk.", ["Legacy system migration", "Warehouse loading", "Reconciliation & QA"]],
  ["07", Boxes, "Knowledge graphs & taxonomy development", "Connect concepts, entities, and relationships so enterprise knowledge becomes easier to navigate.", ["Ontology design", "Entity resolution", "Knowledge graph enrichment"]],
  ["08", GitBranch, "Retrieval-augmented generation support", "Prepare the data, metadata, and retrieval layer that helps enterprise AI answer with context.", ["Chunking & indexing", "Retrieval QA", "Knowledge base operations"]],
  ["09", ShieldCheck, "Intelligent records management", "Bring structure, control, and long-term access to the records your organization depends on.", ["Records classification", "Retention workflows", "Secure access operations"]],
];
